...
public class EditShelveDialogFragment extends DialogFragment {

    // input text : name of the new shelve
    private TextInputEditText editTextShelveName;

    public interface EditShelveDialogListener {
        void editShelve(String newName);
    }

    // Use this instance of the interface to deliver action events
    EditShelveDialogListener listener;
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        builder.setView(view)
                .setTitle(R.string.edit_shelve_name)
    ...
    public void onAttach(Context context) {
        ...
        try {
            ...
            listener = (EditShelveDialogListener) getParentFragment();
        } catch (ClassCastException e) {
            // The activity doesn't implement the interface, throw exception
            throw new ClassCastException(" must implement EditShelveDialogListener");
        }
    }
}